...
echo -e "${BLUE}Running: npm install -g git+https://github.com/YOUR_USERNAME/claude-code.git${NC}"
if npm install -g git+https://github.com/YOUR_USERNAME/claude-code.git; then
